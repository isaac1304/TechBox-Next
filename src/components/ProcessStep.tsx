  ...
  return (
    <article className="card relative flex flex-col gap-3 p-6">
      <div className="flex items-center gap-3">
        <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[image:var(--gradient-brand)] text-sm font-bold text-white shadow-[0_8px_24px_-8px_rgba(42,47,115,0.55)]">
