            ...
            <div className="mt-8 grid gap-8 md:grid-cols-2">
                ...
                >
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-slate-700 dark:text-white/88">Apellido</label>
                            <input
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-slate-700 dark:text-white/88">Empresa</label>
                            <input
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-slate-700 dark:text-white/88">País</label>
                            <input
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-slate-700 dark:text-white/88">Teléfono</label>
                            <input
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-sm font-semibold text-slate-700 dark:text-white/88">Tipo de servicio</label>
                            <select
